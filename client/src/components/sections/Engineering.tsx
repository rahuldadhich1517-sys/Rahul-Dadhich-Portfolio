    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-16 md:mt-24 p-8 rounded-xl border border-border-primary"
          style={{
            background: 'linear-gradient(135deg, var(--color-bg-surface) 0%, var(--color-bg-card) 100%)',
          }}
        >
          <h3 className="text-2xl font-bold text-text-primary mb-4">System Architecture</h3>
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <p className="text-sm text-text-muted uppercase tracking-widest">Frontend</p>
              <p className="text-accent-primary">React / Next.js with TypeScript</p>
            </div>
            <div className="space-y-2">
              <p className="text-sm text-text-muted uppercase tracking-widest">Backend</p>
              <p className="text-accent-primary">Node.js / Express with REST APIs</p>
            </div>
            <div className="space-y-2">
              <p className="text-sm text-text-muted uppercase tracking-widest">Database</p>
              <p className="text-accent-primary">PostgreSQL with Prisma ORM</p>
            </div>
            <div className="space-y-2">
              <p className="text-sm text-text-muted uppercase tracking-widest">Services</p>
              <p className="text-accent-primary">Redis, Azure, AI APIs</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          {[
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 rounded-lg border border-border-primary bg-bg-surface/50 hover:border-accent-primary/50 transition-all"
            >
              <h4 className="text-lg font-bold text-text-primary mb-2">{principle.title}</h4>
